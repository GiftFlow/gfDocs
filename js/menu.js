...
var Menu = new Class({
	...
	menu: [
		...
		[	
			"References",
			{ url: "../ci/index", name: "CodeIgniter" },
			{ url: "../dmz/index", name: "DataMapper" }
		],
		[
			"Libraries",
			{ url: "notify", name: "Notify" }
		],
		[
			"Frequently Used",
			{ url: "../ci/database/active_record", name: "[CI] Active Record Class" },
			{ url: "../ci/libraries/sessions", name: "[CI] Session Class" },
			{ url: "../dmz/pages/get", name: "[DMZ] Get" }
		]
	],
